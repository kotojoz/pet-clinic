...
public class OwnerController {
    ...
    public String processFindForm(Owner owner, BindingResult result, Model model) {
        ...
        if (results.isEmpty()) {
            // no owners found
            result.rejectValue("lastName", "not found", "has not been found");
            return "owners/findOwners";
    ...
    public String processUpdateOwnerFrom(@Validated Owner owner, BindingResult result, @PathVariable Long ownerId) {
        if (result.hasErrors()) {
            return VIEWS_OWNER_CREATE_OR_UPDATE_FORM;
        } else {
            owner.setId(ownerId);
